											...
											<div class="tab-pane fade show active">
												<ul class="list-unstyled list mb-0">
													...
													<li class="py-2"><a href="javascript:void(0);"
														class="d-flex"> <img class="avatar rounded-circle"
															src="${pageContext.request.contextPath}/dist/assets/images/xs/avatar7.jpg"
															alt="">
															<div class="flex-fill ms-2">
																<p class="d-flex justify-content-between mb-0 ">
									...
									<div class="card border-0 w280">
										...
										<div class="list-group m-2 ">
											<a href="task.html"
												...
												href="members.html"
												class="list-group-item list-group-item-action border-0 "><i
												class="icofont-ui-user-group fs-6 me-3"></i>members</a> <a
							...
							<div class="row g-3">
								<div class="col-md-12">
									<div class="card">
										<div
											...
											<h6 class="mb-0 fw-bold ">Lượng truy cập</h6>
										</div>
										<div class="card-body">
								...
								<div class="col-md-12">
									<div class="card">
										<div
											class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
											<h6 class="mb-0 fw-bold ">Số lượng khóa học đã bán</h6>
										</div>
										<div class="card-body">
									...
									<div class="card bg-primary">
										<div class="card-body row">
											<div class="col">
												...
												<span class="text-white">Học viên</span>
											</div>
											<div class="col">
												<img class="img-fluid"
													src="${pageContext.request.contextPath}/dist/assets/images/interview.svg"
													alt="interview">
											</div>
										</div>
									</div>
										...
										<div class="card-body">
											<div class="flex-grow-1">
												...
												<div
													...
													<div class="d-flex align-items-center flex-fill">
														<img class="avatar lg rounded-circle img-thumbnail"
															src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar7.jpg"
															alt="profile">
														<div class="d-flex flex-column ps-3">
						...
						<div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12" style="overflow-x: auto; padding-bottom: 1rem;">
                                        <div style="display: flex; flex-wrap: nowrap; gap: 1rem;">
                                            
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar2.jpg" alt="profile">
                                            ...
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar5.jpg" alt="profile">
                                            ...
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar8.jpg" alt="profile">
                                            ...
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar9.jpg" alt="profile">
                                            ...
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar12.jpg" alt="profile">
                                            ...
                                            <div style="min-width: 220px; flex-shrink: 0;">
                                                <div class="card shadow">
                                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                                        <img class="avatar lg rounded-circle img-thumbnail mx-auto" src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar3.jpg" alt="profile">
											...
											<div style="min-width: 220px; flex-shrink: 0;">
												<div class="card shadow">
													<div
														...
														<img
															class="avatar lg rounded-circle img-thumbnail mx-auto"
															src="${pageContext.request.contextPath}/dist/assets/images/lg/avatar2.jpg"
															alt="profile">
														<h6 class="fw-bold my-2 small-14">Luke Short</h6>
				...
				<div class="modal-dialog modal-dialog-centered modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title  fw-bold" id="addUserLabel">Employee
								Invitation</h5>
